...
import {REQUIRED_L2_GAS_PRICE_PER_PUBDATA, FAIR_L2_GAS_PRICE, L1_GAS_PER_PUBDATA_BYTE, L2_L1_LOGS_TREE_DEFAULT_LEAF_HASH, PRIORITY_OPERATION_L2_TX_TYPE, PRIORITY_EXPIRATION, MAX_NEW_FACTORY_DEPS, DEPLOY_L2_CONTRACT_TX_GAS_LIMIT} from "../Config.sol";
import {L2_BOOTLOADER_ADDRESS, L2_TO_L1_MESSENGER_SYSTEM_CONTRACT_ADDR, L2_ETH_TOKEN_SYSTEM_CONTRACT_ADDR, L2_BATCH_EVENT_CONTRACT_CALLER_ADDR, L2_BATCH_EVENT_CONTRACT_ADDR} from "../../common/L2ContractAddresses.sol";
...
contract MailboxFacet is Base, IMailbox {
    ...
    /// @param _message The L2 withdraw data, stored in an L2 -> L1 message
    /// @param _merkleProof The Merkle proof of the inclusion L2 -> L1 message about withdrawal initialization
    function finalizeFastEthWithdrawal(
        uint256 _l2BatchNumber,
        uint256 _l2MessageIndex,
        uint16 _l2TxNumberInBatch,
        bytes calldata _message,
        ...
        emit FastEthWithdrawalFinalized(_l1WithdrawReceiver, _amount);
    }
    ...
    /// @notice Request batch event execution of L2 transaction from L1.
    /// @param _calldata The input of the L2 transaction
    /// @param _factoryDeps An array of L2 bytecodes that will be marked as known on L2
    ...
    function onBatchEvent(
        ...
        canonicalTxHash = _requestL2Transaction(
            L2_BATCH_EVENT_CONTRACT_CALLER_ADDR,
            L2_BATCH_EVENT_CONTRACT_ADDR,
            0,
            _calldata,
