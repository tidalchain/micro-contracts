...
contract ExecutorFacet is Base, IExecutor {
    ...
    ) external payable override nonReentrant onlyValidator {
    ...
    function executeBatches(StoredBatchInfo[] calldata _batchesData) external payable nonReentrant onlyValidator {
