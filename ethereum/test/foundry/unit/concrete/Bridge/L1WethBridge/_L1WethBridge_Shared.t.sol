...
import {IMicro} from "../../../../../../cache/solpp-generated-contracts/micro/interfaces/IMicro.sol";
...
contract L1WethBridgeTest is Test {
    ...
    function setUp() public {
        ...
        IMicro micro = IMicro(address(diamondProxy));

        L1WethBridge bridge = new L1WethBridge(payable(address(l1Weth)), micro, allowList);
